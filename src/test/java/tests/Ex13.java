...
public class Ex13 {
    ...
    public void testAgent(String agent, String platform, String browser, String device){
        String respPlatform, respBrowser, respDevice;

        JsonPath getAgent = RestAssured
                .given()
